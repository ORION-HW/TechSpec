...
![](./can.png){width=915px height=350px}


!!! note "Примечание"
    Контакт 6 – канал заземления CAN 1 и канал заземления CAN 2 изолированы друг от друга.
...
![](./can-2.png){width=915px height=350px}
...
![](./can-3.png){width=915px height=350px}
